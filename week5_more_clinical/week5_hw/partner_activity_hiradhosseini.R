...
#write total_clinical, modified_clinical df to csv 
  write.csv(total_clinical,"/Users/hiradh/Desktop/qbio_490_hirad_hosseini/week5_more_clinical/week5_hw/total_clinical.csv")
  write.csv(modified_clinical, "/Users/hiradh/Desktop/qbio_490_hirad_hosseini/week5_more_clinical/week5_hw/modified_clinical.csv")

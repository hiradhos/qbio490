...
# write code here
sum(na_boolean_mask)
#This number represents the number of NA values in our na_boolean_mask vector since TRUE represents 1 in binary and sum() counts all of the TRUE values
```
...
# write code here
nrow(attenu) #182
nrow(attenu_cleaned) #166
#This difference of 16 makes sense because it is equal to the value we obtained for is.na(attenu). is.na() is the NA values subtracted from all values for a particular variable
```
